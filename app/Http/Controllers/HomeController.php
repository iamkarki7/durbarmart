...
class HomeController extends Controller
{
    ...
    public function admin_dashboard()
    {
        ...
        $seller_products = Product::where('added_by', 'seller')->count();
        $admin_products = Product::where('added_by', 'admin')->count();
...
// dd($a); 
    ...
    public function subsub(Request $request,$subcat)
    {
        $query = $request->q;
        // dd($subcat);
        $brand_id = '';
        ...
        $subsubcategory_id = (SubSubCategory::where('slug', $subcat)->first() != null) ? SubSubCategory::where('slug', $subcat)->first()->id : null;
...
// dd($a); 
        ...
        return view('frontend.product_listing', compact('products', 'query', 'subsubcategory_id', 'brand_id', 'sort_by', 'seller_id','min_price', 'max_price', 'attributes', 'selected_attributes', 'all_colors', 'selected_color','location_id','brands'));
    }
