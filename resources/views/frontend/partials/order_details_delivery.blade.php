        ...
        <div class="col-lg-4 col-sm-6">
            <div class="form-inline">
                <select class="form-control selectpicker form-control-sm"  data-minimum-results-for-search="Infinity" id="update_delivery_status">
                    ...
                    <option value="cancel_delivery" @if ($status == 'cancel_delivery') selected @endif>{{__('Cancel Delivery')}}</option>
                    <option value="return" @if ($status == 'return') selected @endif>{{__('Returned')}}</option>
