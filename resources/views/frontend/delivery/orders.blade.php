                        ...
                        <div class="card no-border mt-4">
                            ...
                            <form class="" id="sort_orders2" action="" method="GET">
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li role="presentation"
                                        class="nav-item sort_order2_li "
                                        value="cancel_delivery"><a class="@isset($delivery_status) @if ($delivery_status == 'cancel_delivery') active @endif @endisset" href="javascript:void(0);">Cancelled</a></li>
                                    <li role="presentation"
                                        class="nav-item sort_order2_li "
                                        value="return"><a class="@isset($delivery_status) @if ($delivery_status == 'return') active @endif @endisset" href="javascript:void(0);">Returned</a></li>
                                </ul>
                            </form>
